...
siteinfo <- read.csv( "../../input_pmodel_test_sofun/siteinfo_pmodel_test_sofun.csv" )
...
path_fapar_allsites_csv <- "../../input_pmodel_test_sofun/sitedata/fapar/fapar_modis_allsites.csv"
...
for (idx in seq(nsites)){
  ...
  dirnam_fapar_csv <- paste( "../../input_pmodel_test_sofun/sitedata/fapar/", sitename, "/", sep="" )
  ...
  for (yr in unique(df_fapar$year)){
    ...
    dirnam <- paste( "../../input_pmodel_test_sofun/sitedata/fapar/", sitename, "/", as.character(yr), "/", sep="" )

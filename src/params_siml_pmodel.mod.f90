...
contains
  ...
  function getpar_siml( runname ) result( out_getpar_siml )
    ...
    out_getpar_siml%ndep_noy_forcing_file = 'NA'
    out_getpar_siml%ndep_nhx_forcing_file = 'NA'
    out_getpar_siml%nfert_noy_forcing_file = 'NA'
    out_getpar_siml%nfert_nhx_forcing_file = 'NA'
    out_getpar_siml%do_grharvest_forcing_file = 'NA'

    call getparstring( 'run/'//runname//'.sofun.parameter', 'fapar_forcing_source', out_getpar_siml%fapar_forcing_source )

    out_getpar_siml%const_lu    = .false.
    out_getpar_siml%const_ndep  = .false.
    out_getpar_siml%const_nfert = .false.
    ...
    out_getpar_siml%loutdnpp       = .false.
    out_getpar_siml%loutdnup       = .false.
    out_getpar_siml%loutdcex       = .false.
    out_getpar_siml%loutdCleaf     = .false.
    out_getpar_siml%loutdCroot     = .false.
    out_getpar_siml%loutdClabl     = .false.
    out_getpar_siml%loutdNlabl     = .false.
    out_getpar_siml%loutdClitt     = .false.
    out_getpar_siml%loutdNlitt     = .false.
    out_getpar_siml%loutdlai       = .false.
    out_getpar_siml%loutdfapar     = getparlogical( 'run/'//runname//'.sofun.parameter', 'loutdfapar' )
    out_getpar_siml%loutdninorg    = .false.
    out_getpar_siml%loutdtemp_soil = getparlogical( 'run/'//runname//'.sofun.parameter', 'loutdtemp_soil' )
    
    out_getpar_siml%loutntransform = .false.
    out_getpar_siml%loutwaterbal   = getparlogical( 'run/'//runname//'.sofun.parameter', 'loutwaterbal')
    out_getpar_siml%loutlittersom  = .false.
    out_getpar_siml%loutnuptake    = .false.

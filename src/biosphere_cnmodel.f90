module md_biosphere
  ...
  use md_plant, only: plant_type, initdaily_plant, initglobal_plant, getout_daily_plant, &
  ...
  use md_waterbal, only: solartype, waterbal, getsolar, initdaily_waterbal, initglobal_waterbal, &
  ...
  use md_gpp, only: outtype_pmodel, getpar_modl_gpp, initio_gpp, initoutput_gpp, initdaily_gpp, getlue, gpp, &
...
contains
  ...
  function biosphere_annual() result( c_uptake )
    ...
    if (interface%steering%init) then
      ...
      call initglobal_waterbal( tile(:,:) )
      call initglobal_littersom( tile(:,:) )
      call initglobal_ntransform( tile(:,:) )
